...
const companyTableReducer = (state = initialState, action = {}) => produce(state, draft => {
  const { branch } = action;
  switch (action.type) {
    ...
    case `${branch}/${ADD_NEW}`: {
      ...
      draft.showFrm = true;
      draft.formTitle = 'Add New Company';
      break;
    }
